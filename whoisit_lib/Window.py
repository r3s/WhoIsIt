...
import logging
logger = logging.getLogger('whoisit_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by WhoisitWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseWhoisitWindow object.
        """
        builder = get_builder('WhoisitWindow')
        new_object = builder.get_object("whoisit_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a WhoisitWindow object with it in order to finish
        initializing the start of the new WhoisitWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.whoisit")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('whoisit')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for whoisit."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for whoisit."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the WhoisitWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the WhoisitWindow is closed."""
